...
class Phonebook:
    def __init__(self):
        ...
        self.es = Elasticsearch("http://localhost:9200/", api_key="<YOUR_API_KEY>")
    ...
    def add_contact(self, name, phone_number):
        ...
        search_check = self.es.search(index=self.index_name, query={"match": {"name": {"query": "Alice Smith"}}})
        if not search_check:
    ...
    def search_contact(self, initials):
        ...
        query = {"query": {"prefix": {"name": {"value": initials}}}}
...
if __name__ == "__main__":
    ...
    if operation == "add":
        ...
        search_results = phonebook.search_contact(search.lower())
